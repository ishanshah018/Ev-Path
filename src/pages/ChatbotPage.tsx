  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'bot',
      content: "Hi! I'm your EV Assistant. I can help you with charging stations, route planning, EV recommendations, and answer any questions about electric vehicles. How can I assist you today?",
      timestamp: new Date()
    }
  ]);
